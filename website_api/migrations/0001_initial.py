# Generated by Django 4.2.6 on 2023-12-29 17:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('integrated_language', models.CharField(blank=True, choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=5000, null=True)),
                ('course_specialization', models.CharField(max_length=5000)),
                ('diploma_supplement', models.CharField(blank=True, choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=5000, null=True)),
                ('integrated_internship', models.CharField(blank=True, choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=5000, null=True)),
                ('integrated_foreign_language', models.CharField(blank=True, max_length=5000, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ProgramDetails',
            fields=[
                ...
                ('program_abbreviation', models.CharField(blank=True, max_length=200, null=True)),
                ('degree_abbreviation', models.CharField(max_length=50)),
                ('program_website', models.CharField(blank=True, max_length=1000, null=True)),
                ('instagram_url', models.CharField(blank=True, max_length=1000, null=True)),
                ('linkedin_url', models.CharField(blank=True, max_length=1000, null=True)),
                ('facebook_url', models.CharField(blank=True, max_length=1000, null=True)),
                ('twitter_url', models.CharField(blank=True, max_length=1000, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_image', models.ImageField(blank=True, null=True, upload_to=website_api.models.Universities.upload_photo)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('part_time_employment', models.CharField(blank=True, max_length=3000, null=True)),
                ('career_advisory_service', models.CharField(blank=True, max_length=3000, null=True)),
                ('special_or_non_special_support', models.CharField(blank=True, max_length=3000, null=True)),
                ('program_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='service', to='website_api.programdetails')),
            ],
        ),
        migrations.CreateModel(
            name='Requirement',
            fields=[
                ...
                ('language_requirement', models.CharField(blank=True, max_length=3000, null=True)),
                ('application_requirement', models.CharField(max_length=3000)),
                ('submit_application_to', models.CharField(blank=True, max_length=3000, null=True)),
                ('program_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requirement', to='website_api.programdetails')),
            ],
        ),
        migrations.AddField(
            model_name='programdetails',
            name='uni_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='program_details', to='website_api.universities'),
        ),
        migrations.CreateModel(
            name='Overview',
            fields=[
                ...
                ('combine_master_phd', models.CharField(blank=True, choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=1000, null=True)),
                ('joint_degree_program', models.CharField(blank=True, choices=[('YES', 'YES'), ('NO', 'NO')], default='YES', max_length=1000, null=True)),
                ('program_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='overview', to='website_api.programdetails')),
            ],
        ),
        migrations.CreateModel(
            name='OnlineProgram',
            fields=[
                ...
                ('online_adaptability', models.CharField(blank=True, max_length=100, null=True)),
                ('pace_of_course', models.CharField(blank=True, max_length=100, null=True)),
                ('attendance_phase_in_Nigeria', models.CharField(blank=True, max_length=100, null=True)),
                ('type_of_online_learning', models.CharField(blank=True, max_length=100, null=True)),
                ('program_id', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='online_program', to='website_api.programdetails')),
            ],
        ),
        migrations.CreateModel(
            name='OnlineLearning',
            fields=[
                ...
                ('online_learning', models.CharField(blank=True, max_length=500, null=True)),
                ('course_details_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='online_learning', to='website_api.onlineprogram')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            ...
            name='program_id',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='course_details', to='website_api.programdetails'),
        ),
        migrations.CreateModel(
            name='CostFunding',
            fields=[
                ...
                ('funding_opportunities', models.CharField(blank=True, max_length=2000, null=True)),
                ('funding_description', models.CharField(blank=True, max_length=2000, null=True)),
                ('program_id', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='cost_funding', to='website_api.programdetails')),
            ],
        ),
        migrations.CreateModel(
            name='AssessmentType',
